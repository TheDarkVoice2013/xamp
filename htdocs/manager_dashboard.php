            ...
            <div id="content">
                ...
                <div id="create-hotel">
                    ...
                    <div id="hotel-form" >
                        ...
                        <div class="form-group">
                        <label for="hotel_description">Short Description:</label>
                        <textarea id="hotel_description" name="hotel_description" rows="5" cols="50" required></textarea>
                        </div>
                        ...
                        <button id="submit_hotel">Create Hotel</button>
                    </div>
                </div>
  ...
  cursor: pointer;
    ...
    <script>
         $(document).ready(function(){
            $('#submit_hotel').on('click', function() {
                var name = document.getElementById("hotel_name").value;
                var location = document.getElementById("hotel_location").value;
                var description = document.getElementById("hotel_description").value;
                var image = document.getElementById("hotel_image").value;
                var path = image.split("\\").pop();
                var newFilePath = "img/" + path;
